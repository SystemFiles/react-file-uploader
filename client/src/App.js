...
export default function App () {
    ...
    try {
      ...
      if (result.status === 200) {
        setState({
          ...
          showDetails   : true,
          error         : false,
          shareLink     : `${window.location}download/${result.data.id}`
        })
        setTimeout(() => {
          setState({
            uploading     : false,
  ...
  return (
    <div className='container'>
      ...
      <Grid className='uploadDetails' container spacing={0} justify='center' alignItems='center' alignContent='center'>
          ...
          <Collapse in={state.showDetails}>
            <div className='uploadDetails-container'>
              ...
              <Grid container>
                ...
                <p>
                  <span>** TIP: Click on the link field or copy icon to copy the link to your clipboard. **</span>
                </p>
              </Grid>
            </div>
          </Collapse>
